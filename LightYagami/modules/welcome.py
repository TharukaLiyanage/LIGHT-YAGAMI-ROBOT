...
import LightYagami.modules.sql.welcome_sql as sql
...
from LightYagami.modules.helper_funcs.misc import build_keyboard, revert_buttons
from LightYagami.modules.helper_funcs.msg_types import get_welcome_type
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome yourself
                ...
                update.effective_message.reply_text("Now It's Time To Provide Justice To The Group\nBut You Have To PROMOTE ME So I can Do As Better As Possible")
                if creator:
                    bot.send_message(
                        JOIN_LOGGER,
